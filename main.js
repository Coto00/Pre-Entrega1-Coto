    ...
    while (repetir === false) {
        ...
        while (repetir2 === false) {
            ...
            if (opcion === "") {
                ...
                let colorRemera = prompt('De qué color quieres tu Remera');
                ...
                let colorBuzo = prompt('De qué color quieres tu Buzo');
                ...
                let colorCampera = prompt('De qué color quieres tu Campera');
                ...
                let colorPantalon = prompt('De qué color quieres tu Pantalón');
